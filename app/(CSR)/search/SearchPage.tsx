...
function SearchPage() {
  ...
  return (
    <div>
        <Alert>
            This page fetches data <strong>client-side</strong>. In order to not leak API credentials, the request is sent to a NextJs <strong>route handler</strong> then fethces the data from the Unsplash API and returns it to the client.
        </Alert>
        <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3" controlId="search-input">
                <Form.Label>Search query</Form.Label>
                <Form.Control name="query" placeholder="Search images"/>
            </Form.Group>
        ...
        <div className="d-flex flex-column align-items-center">
            ...
            {loadingIsError && <p>Something went wrong. Please try again.</p>}
